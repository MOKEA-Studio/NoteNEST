...
export default function SettingsPage({ settings, pages, currentPage, onSave, onImport, onBack, onOpenSidebar }) {
  ...
  return (
    <main className="settings-shell expanded-settings" data-section={section}>
